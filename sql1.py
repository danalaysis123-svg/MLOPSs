...
def create_employee():
    ...
    for i in range(n):
        ...
        department = get_int_input("Enter Department ID: ")
        salary = get_float_input("Enter Employee Salary: ")
        experience = get_int_input("Enter Experience (in years): ")
        ...
        result = execute_query(
            query, (emp_id, name, department, salary, experience)
        )
...
def update_employee():
    ...
    department = get_int_input("Enter New Department ID: ")
    salary = get_float_input("Enter New Salary: ")
    experience = get_int_input("Enter New Experience (in years): ")
    ...
    result = execute_query(query, (name, department, salary, experience, emp_id))
